...
b <- as.data.frame(xx)
write.table(b, "../res/5.gredient_sdi_cellType/compare_cluster_KEGG.tsv", sep="\t", quote=F, row.names = T, col.names = T)


##########################
# Compare analysis: whole brain
##########################
gene_sdi_L <- read.csv("../res/5.gredient_sdi_cellType/gene_sdi_L.wholebrain.tsv", sep="\t", header = F)
head_n = round(nrow(gene_sdi_L) * 0.25)
tail_n = round(nrow(gene_sdi_L) * 0.75)
...
gene_sdi_R <- read.csv("../res/5.gredient_sdi_cellType/gene_sdi_R.wholebrain.tsv",sep="\t", header = F)
head_n = round(nrow(gene_sdi_R) * 0.25)
tail_n = round(nrow(gene_sdi_R) * 0.75)
...
b <- as.data.frame(xx)
write.table(b, "../res/5.gredient_sdi_cellType/compare_cluster_KEGG.wholeBrain.tsv", sep="\t", quote=F, row.names = T, col.names = T)



##########################
# Compare analysis: inter region
##########################
gene_sdi_L <- read.csv("../res/5.gredient_sdi_cellType/gene_sdi_L.inter.tsv", sep="\t", header = F)
head_n = round(nrow(gene_sdi_L) * 0.25)
tail_n = round(nrow(gene_sdi_L) * 0.75)
...
gene_sdi_R <- read.csv("../res/5.gredient_sdi_cellType/gene_sdi_R.inter.tsv",sep="\t", header = F)
head_n = round(nrow(gene_sdi_R) * 0.25)
tail_n = round(nrow(gene_sdi_R) * 0.75)
...
b <- as.data.frame(xx)
write.table(b, "../res/5.gredient_sdi_cellType/compare_cluster_KEGG.inter.tsv", sep="\t", quote=F, row.names = T, col.names = T)
